...
class TransjatimScreen extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Platform informasi rute, tiket, dan pelacakan bus Trans Jatim secara real-time.',
                      style: TextStyle(
                    ...
                    // Blue Gradient Button 2
                    _buildGradientButton(
                      context,
                      title: 'Tiket & Rute Transjatim',
  ...
  Widget _buildGradientButton(BuildContext context, {required String title, required IconData icon, required VoidCallback onTap}) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
