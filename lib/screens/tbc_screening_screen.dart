...
import 'tbc_reminder_screen.dart';

class TbcScreeningScreen extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: NetworkImage('https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=800'),
                          fit: BoxFit.cover,
                        ),
                    ...
                    const Text(
                      'Jawab 6 pertanyaan sederhana untuk mengecek potensi dan risiko TBC pada diri Anda secara gratis, hanya dalam waktu 3 menit.',
                      style: TextStyle(color: Color(0xFF64748B), fontSize: 14, fontFamily: 'Inter', height: 1.50),
                    ),
                    const SizedBox(height: 32),
                    _buildGradientButton(
                      title: 'Mulai Skrining Mandiri',
                    ...
                    _buildGradientButton(
                      title: 'Riwayat Skrining Saya',
                      icon: Icons.history_rounded,
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const TbcReminderScreen()),
                        );
                      },
                    ),
                  ],
